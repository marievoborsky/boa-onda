...
WHO2FIG = {'ana': 'ana', 'marie': 'marie', 'joão': 'joao', 'joao': 'joao', 'vasco': 'vasco', 'tomás': 'ana', 'tomas': 'ana', 'empregado': 'vasco', 'empregada': 'marie', 'vendedora': 'marie', 'vendedor': 'vasco', 'senhor': 'vasco', 'motorista': 'vasco', 'senhora': 'ana', 'avó': 'ana', 'avo': 'ana', 'pai': 'vasco', 'mãe': 'ana', 'mae': 'ana', 'inês': 'ana', 'ines': 'ana', 'tio': 'vasco', 'rui': 'joao', 'senhoria': 'ana', 'senhorio': 'vasco', 'operador': 'vasco', 'mecânico': 'vasco', 'mecanico': 'vasco'}  # Tomás (12): Ana-Stimme – Kinderstimmen-Design ist bei ElevenLabs zu Recht gesperrt
